...
out.to_csv('../outputs/final3/ranges_dbscan.csv', sep = '\t')

evaluation = evaluator.evaluate(merged_ranges = out, model_name="dbscan")
evaluation.to_csv('../outputs/final3/evaluate_dbscan.csv', sep = '\t')

processed_out = evaluator.process_ranges(out)
processed_out.to_csv('../outputs/final3/ranges2_dbscan.csv', sep = '\t')

evaluation2 = evaluator.evaluate(merged_ranges = processed_out, model_name="dbscan processed")
evaluation2.to_csv('../outputs/final3/evaluate2_dbscan.csv', sep = '\t')

enrichment_coeffs = enrichment.calculate_enrichment_factors(processed_out)
enrichment_coeffs.to_csv('../outputs/final3/enrichment_dbscan.csv', sep = '\t')
