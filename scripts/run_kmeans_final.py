...
out.to_csv('../outputs/final3/ranges_kmeans.csv', sep = '\t')

evaluation = evaluator.evaluate(merged_ranges = out, model_name="k-means")
evaluation.to_csv('../outputs/final3/evaluate_kmeans.csv', sep = '\t')

processed_out = evaluator.process_ranges(out)
processed_out.to_csv('../outputs/final3/ranges2_kmeans.csv', sep = '\t')

evaluation2 = evaluator.evaluate(merged_ranges = processed_out, model_name="k-means processed")
evaluation2.to_csv('../outputs/final3/evaluate2_kmeans.csv', sep = '\t')

enrichment_coeffs = enrichment.calculate_enrichment_factors(processed_out)
enrichment_coeffs.to_csv('../outputs/final3/enrichment_kmeans.csv', sep = '\t')
