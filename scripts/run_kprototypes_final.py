...
out.to_csv('../outputs/final2/ranges_kprototypes.csv', sep = '\t')

evaluation = evaluator.evaluate(merged_ranges = out, model_name="k-prototypes")
evaluation.to_csv('../outputs/final2/evaluate_kprototypes.csv', sep = '\t')

processed_out = evaluator.process_ranges(out)
processed_out.to_csv('../outputs/final2/ranges2_kprototypes.csv', sep = '\t')

evaluation2 = evaluator.evaluate(merged_ranges = processed_out, model_name="k-prototypes processed")
evaluation2.to_csv('../outputs/final2/evaluate2_kprototypes.csv', sep = '\t')
...
enrichment_coeffs.to_csv('../outputs/final2/enrichment_kprototypes.csv', sep = '\t')
